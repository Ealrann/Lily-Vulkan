...
{
	public static final int STAGE_FLAGS = EShaderStage.VERTEX_BIT.value() | EShaderStage.FRAGMENT_BIT.value();
	...
	{
		final int width = pushConstants.width();
		final int height = pushConstants.height();
		...
		buffer.putInt(pushConstants.currentDescriptor());
