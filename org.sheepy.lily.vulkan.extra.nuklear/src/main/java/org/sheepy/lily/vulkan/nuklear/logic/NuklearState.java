...
public final record NuklearState(NkAllocator allocator, NkContext nkContext, NkBuffer cmds, NkBuffer vbuf,
								 NkBuffer ebuf, NkDrawNullTexture nkNullTexture, NkConvertConfig config)
{
	...
	public static final class Builder
	{
		...
		public NuklearState build(final NkUserFont defaultNkFont, final Window window)
		{
