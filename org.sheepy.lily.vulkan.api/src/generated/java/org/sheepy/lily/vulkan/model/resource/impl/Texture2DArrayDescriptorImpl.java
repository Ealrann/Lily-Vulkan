 ...
 *   <li>{@link org.sheepy.lily.vulkan.model.resource.impl.Texture2DArrayDescriptorImpl#getDescriptorType <em>Descriptor Type</em>}</li>
...
public class Texture2DArrayDescriptorImpl extends LilyEObject implements Texture2DArrayDescriptor
{
	...
	public void setDescriptorType(EDescriptorType newDescriptorType)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcePackage.TEXTURE2_DARRAY_DESCRIPTOR__DESCRIPTOR_TYPE, oldDescriptorType, descriptorType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case ResourcePackage.TEXTURE2_DARRAY_DESCRIPTOR__NAME:
				return getName();
			case ResourcePackage.TEXTURE2_DARRAY_DESCRIPTOR__DESCRIPTOR_TYPE:
