...
public class VulkanResourcePackageImpl extends EPackageImpl implements VulkanResourcePackage
{
	 ...
	 * @generated
	 */
	private EClass iBufferDataSourceEClass = null;
	 ...
	 * @generated
	 */
	private EClass iVulkanImageEClass = null;
	 ...
	 * @see org.sheepy.lily.vulkan.model.vulkanresource.VulkanResourcePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EAttribute getIBuffer_Usages()
	{
		return (EAttribute)iBufferEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EClass getIBufferDataSource()
	{
		return iBufferDataSourceEClass;
	}
	 ...
	 */
	@Override
	public EReference getFileImageDataProvider_FileImageReference()
	{
	 ...
	 */
	@Override
	public EReference getFileImageDataProvider_FileImageContainment()
	{
		return (EReference)fileImageDataProviderEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getImageDescriptor_Images()
	{
	...
	{
		return (EAttribute)bufferViewerEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getBufferViewer_DataSource()
	{
		return (EReference)bufferViewerEClass.getEStructuralFeatures().get(3);
	}
	...
	public void createPackageContents()
	{
		...
		createEAttribute(iBufferEClass, IBUFFER__USAGES);
		...
		iBufferDataSourceEClass = createEClass(IBUFFER_DATA_SOURCE);
		...
		createEReference(fileImageDataProviderEClass, FILE_IMAGE_DATA_PROVIDER__FILE_IMAGE_REFERENCE);
		createEReference(fileImageDataProviderEClass, FILE_IMAGE_DATA_PROVIDER__FILE_IMAGE_CONTAINMENT);
		...
		createEReference(imageDescriptorEClass, IMAGE_DESCRIPTOR__IMAGES);
	...
	public void initializePackageContents()
	{
		...
		transferBufferEClass.getESuperTypes().add(theVulkanPackage.getIVulkanResource());
		constantBufferEClass.getESuperTypes().add(theVulkanPackage.getIVulkanResource());
		...
		samplerEClass.getESuperTypes().add(theVulkanPackage.getIVulkanResource());
		...
		shaderEClass.getESuperTypes().add(theVulkanPackage.getIVulkanResource());
		memoryChunkEClass.getESuperTypes().add(theVulkanPackage.getIVulkanResource());
		...
		iVulkanImageEClass.getESuperTypes().add(theResourcePackage.getIImage());
		compositeImageEClass.getESuperTypes().add(this.getIVulkanImage());
		compositeImageEClass.getESuperTypes().add(theImagePackage.getImageInfo());
		staticImageEClass.getESuperTypes().add(this.getIMemoryChunkPart());
		staticImageEClass.getESuperTypes().add(this.getIVulkanImage());
		...
		imageViewerEClass.getESuperTypes().add(this.getIVulkanImage());
		imageViewerEClass.getESuperTypes().add(theImagePackage.getImageInfo());
		...
		initEAttribute(getIBuffer_Usages(), theEnumerationPackage.getEBufferUsage(), "usages", null, 0, -1, IBuffer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(iBufferDataSourceEClass, IBufferDataSource.class, "IBufferDataSource", IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEReference(getFileImageDataProvider_FileImageReference(), theResourcePackage.getFileImage(), null, "fileImageReference", null, 1, 1, FileImageDataProvider.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFileImageDataProvider_FileImageContainment(), theResourcePackage.getFileImage(), null, "fileImageContainment", null, 1, 1, FileImageDataProvider.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(imageInlayEClass, ImageInlay.class, "ImageInlay", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getImageInlay_Image(), this.getIVulkanImage(), null, "image", null, 1, 1, ImageInlay.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSampler_Image(), this.getIVulkanImage(), null, "image", null, 0, 1, Sampler.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getImageDescriptor_Images(), this.getIVulkanImage(), null, "images", null, 0, -1, ImageDescriptor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getImageDescriptor_Layout(), theEnumerationPackage.getEImageLayout(), "layout", "GENERAL", 0, 1, ImageDescriptor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getImageBarrier_Image(), this.getIVulkanImage(), null, "image", null, 1, 1, ImageBarrier.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getBufferMemory_Buffers(), this.getIBuffer(), null, "buffers", null, 0, -1, BufferMemory.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCompositeImage_Background(), this.getIVulkanImage(), null, "background", null, 1, 1, CompositeImage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
