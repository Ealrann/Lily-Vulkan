...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Abstract Graphics Pipeline</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 *   <li>{@link org.sheepy.lily.vulkan.model.process.graphic.impl.AbstractGraphicsPipelineImpl#getSubpass <em>Subpass</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractGraphicsPipelineImpl extends AbstractPipelineImpl
		implements AbstractGraphicsPipeline
{
	/**
	 ...
	 * @generated
	 */
	public AbstractGraphicsPipelineImpl()
	{
		super();
	}
	...
	{
		return GraphicPackage.Literals.ABSTRACT_GRAPHICS_PIPELINE;
	}
	...
	public EList<Shader> getShaders()
	{
		if (shaders == null)
		{
			shaders = new EObjectResolvingEList<Shader>(Shader.class, this,
					GraphicPackage.ABSTRACT_GRAPHICS_PIPELINE__SHADERS);
		}
		return shaders;
	}
													...
													NotificationChain msgs)
	{
		...
		if (eNotificationRequired())
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					GraphicPackage.ABSTRACT_GRAPHICS_PIPELINE__VIEWPORT_STATE, oldViewportState,
					newViewportState);
		...
		if (newViewportState != viewportState)
		{
			...
			if (viewportState != null) msgs = ((InternalEObject) viewportState).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE
							- GraphicPackage.ABSTRACT_GRAPHICS_PIPELINE__VIEWPORT_STATE,
					null, msgs);
	...
	public NotificationChain basicSetRasterizer(Rasterizer newRasterizer, NotificationChain msgs)
	{
		...
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					GraphicPackage.ABSTRACT_GRAPHICS_PIPELINE__RASTERIZER, oldRasterizer,
					newRasterizer);
			if (msgs == null) msgs = notification;
			else msgs.add(notification);
		}
	...
	public void setRasterizer(Rasterizer newRasterizer)
	{
		if (newRasterizer != rasterizer)
		{
			...
			if (rasterizer != null) msgs = ((InternalEObject) rasterizer).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - GraphicPackage.ABSTRACT_GRAPHICS_PIPELINE__RASTERIZER,
					null, msgs);
			...
			if (msgs != null) msgs.dispatch();
				...
				GraphicPackage.ABSTRACT_GRAPHICS_PIPELINE__RASTERIZER, newRasterizer,
				newRasterizer));
	}
	...
	public NotificationChain basicSetColorBlend(ColorBlend newColorBlend, NotificationChain msgs)
	{
		...
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					GraphicPackage.ABSTRACT_GRAPHICS_PIPELINE__COLOR_BLEND, oldColorBlend,
					newColorBlend);
			if (msgs == null) msgs = notification;
			else msgs.add(notification);
		}
	...
	public void setColorBlend(ColorBlend newColorBlend)
	{
		if (newColorBlend != colorBlend)
		{
			...
			if (colorBlend != null) msgs = ((InternalEObject) colorBlend).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - GraphicPackage.ABSTRACT_GRAPHICS_PIPELINE__COLOR_BLEND,
					null, msgs);
			...
			if (msgs != null) msgs.dispatch();
				...
				GraphicPackage.ABSTRACT_GRAPHICS_PIPELINE__COLOR_BLEND, newColorBlend,
				newColorBlend));
	}
													...
													NotificationChain msgs)
	{
		...
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					GraphicPackage.ABSTRACT_GRAPHICS_PIPELINE__DYNAMIC_STATE, oldDynamicState,
					newDynamicState);
			if (msgs == null) msgs = notification;
			else msgs.add(notification);
		}
	...
	public void setDynamicState(DynamicState newDynamicState)
	{
		if (newDynamicState != dynamicState)
		{
			...
			if (dynamicState != null)
				msgs = ((InternalEObject) dynamicState).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- GraphicPackage.ABSTRACT_GRAPHICS_PIPELINE__DYNAMIC_STATE,
						null, msgs);
			...
			if (msgs != null) msgs.dispatch();
				...
				GraphicPackage.ABSTRACT_GRAPHICS_PIPELINE__DYNAMIC_STATE, newDynamicState,
				newDynamicState));
	}
	...
	public void setSubpass(int newSubpass)
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				GraphicPackage.ABSTRACT_GRAPHICS_PIPELINE__SUBPASS, oldSubpass, subpass));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
		case GraphicPackage.ABSTRACT_GRAPHICS_PIPELINE__SHADERS:
			return getShaders();
		case GraphicPackage.ABSTRACT_GRAPHICS_PIPELINE__VIEWPORT_STATE:
