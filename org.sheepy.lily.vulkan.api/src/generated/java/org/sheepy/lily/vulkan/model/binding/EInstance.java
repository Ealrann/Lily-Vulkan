...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>EInstance</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.sheepy.lily.vulkan.model.binding.BindingPackage#getEInstance()
 * @model
 * @generated
 */
public enum EInstance implements Enumerator
{
	/**
	...
	/**
	 * An array of all the '<em><b>EInstance</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final EInstance[] VALUES_ARRAY =
		new EInstance[]
		{
			CONTEXT_INSTANCE,
	...
	/**
	 * A public read-only list of all the '<em><b>EInstance</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<EInstance> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>EInstance</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static EInstance get(String literal)
	{
		for (int i = 0; i < VALUES_ARRAY.length; ++i)
		{
			EInstance result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>EInstance</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static EInstance getByName(String name)
	{
		for (int i = 0; i < VALUES_ARRAY.length; ++i)
		{
			EInstance result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>EInstance</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static EInstance get(int value)
	{
		switch (value)
		{
	 ...
	 * @generated
	 */
	private EInstance(int value, String name, String literal)
	{
		this.value = value;
		this.name = name;
