...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>EFilter</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.sheepy.lily.vulkan.model.enumeration.EnumerationPackage#getEFilter()
 * @model
 * @generated
 */
public enum EFilter implements Enumerator
{
	/**
	...
	/**
	 * An array of all the '<em><b>EFilter</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final EFilter[] VALUES_ARRAY =
		new EFilter[]
		{
			NEAREST,
			LINEAR,
	 ...
	 * @generated
	 */
	public static EFilter get(String literal)
	{
		for (int i = 0; i < VALUES_ARRAY.length; ++i)
		{
			EFilter result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>EFilter</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static EFilter getByName(String name)
	{
		for (int i = 0; i < VALUES_ARRAY.length; ++i)
		{
			EFilter result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>EFilter</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static EFilter get(int value)
	{
		switch (value)
		{
	 ...
	 * @generated
	 */
	private EFilter(int value, String name, String literal)
	{
		this.value = value;
		this.name = name;
