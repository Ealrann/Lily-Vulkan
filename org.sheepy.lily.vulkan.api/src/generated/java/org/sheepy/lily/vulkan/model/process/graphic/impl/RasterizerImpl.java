...
public class RasterizerImpl extends MinimalEObjectImpl.Container implements Rasterizer
{
	...
	public void setCullMode(ECullMode newCullMode)
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				GraphicPackage.RASTERIZER__CULL_MODE, oldCullMode, cullMode));
	}
	...
	public void setFrontFace(EFrontFace newFrontFace)
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				GraphicPackage.RASTERIZER__FRONT_FACE, oldFrontFace, frontFace));
	}
	...
	public void setPolygonMode(EPolygonMode newPolygonMode)
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				GraphicPackage.RASTERIZER__POLYGON_MODE, oldPolygonMode, polygonMode));
	}
	...
	public void setLineWidth(int newLineWidth)
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				GraphicPackage.RASTERIZER__LINE_WIDTH, oldLineWidth, lineWidth));
	}
	...
	public void setDepthClampEnable(boolean newDepthClampEnable)
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				GraphicPackage.RASTERIZER__DEPTH_CLAMP_ENABLE, oldDepthClampEnable,
				depthClampEnable));
	}
	...
	public void setDiscardEnable(boolean newDiscardEnable)
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				GraphicPackage.RASTERIZER__DISCARD_ENABLE, oldDiscardEnable, discardEnable));
	}
	...
	public void setDepthBiasEnable(boolean newDepthBiasEnable)
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				GraphicPackage.RASTERIZER__DEPTH_BIAS_ENABLE, oldDepthBiasEnable, depthBiasEnable));
	}
