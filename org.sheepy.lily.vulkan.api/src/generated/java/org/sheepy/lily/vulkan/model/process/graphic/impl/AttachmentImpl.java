 ...
 * </p>
 * <ul>
 *   <li>{@link org.sheepy.lily.vulkan.model.process.graphic.impl.AttachmentImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.sheepy.lily.vulkan.model.process.graphic.impl.AttachmentImpl#getSamples <em>Samples</em>}</li>
 *   <li>{@link org.sheepy.lily.vulkan.model.process.graphic.impl.AttachmentImpl#getLoadOp <em>Load Op</em>}</li>
 *   <li>{@link org.sheepy.lily.vulkan.model.process.graphic.impl.AttachmentImpl#getStoreOp <em>Store Op</em>}</li>
 *   <li>{@link org.sheepy.lily.vulkan.model.process.graphic.impl.AttachmentImpl#getStencilLoadOp <em>Stencil Load Op</em>}</li>
 *   <li>{@link org.sheepy.lily.vulkan.model.process.graphic.impl.AttachmentImpl#getStencilStoreOp <em>Stencil Store Op</em>}</li>
 *   <li>{@link org.sheepy.lily.vulkan.model.process.graphic.impl.AttachmentImpl#getInitialLayout <em>Initial Layout</em>}</li>
 *   <li>{@link org.sheepy.lily.vulkan.model.process.graphic.impl.AttachmentImpl#getFinalLayout <em>Final Layout</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AttachmentImpl extends LilyEObject implements Attachment
{
	/**
	...
	{
		return GraphicPackage.Literals.ATTACHMENT;
	}
	...
	public void setName(String newName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphicPackage.ATTACHMENT__NAME, oldName, name));
	}
	...
	public void setSamples(ESampleCount newSamples)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphicPackage.ATTACHMENT__SAMPLES, oldSamples, samples));
	}
	...
	public void setLoadOp(EAttachmentLoadOp newLoadOp)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphicPackage.ATTACHMENT__LOAD_OP, oldLoadOp, loadOp));
	}
	...
	public void setStoreOp(EAttachmentStoreOp newStoreOp)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphicPackage.ATTACHMENT__STORE_OP, oldStoreOp, storeOp));
	}
	...
	public void setStencilLoadOp(EAttachmentLoadOp newStencilLoadOp)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphicPackage.ATTACHMENT__STENCIL_LOAD_OP, oldStencilLoadOp, stencilLoadOp));
	}
	...
	public void setStencilStoreOp(EAttachmentStoreOp newStencilStoreOp)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphicPackage.ATTACHMENT__STENCIL_STORE_OP, oldStencilStoreOp, stencilStoreOp));
	}
	...
	public void setInitialLayout(EImageLayout newInitialLayout)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphicPackage.ATTACHMENT__INITIAL_LAYOUT, oldInitialLayout, initialLayout));
	}
	...
	public void setFinalLayout(EImageLayout newFinalLayout)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphicPackage.ATTACHMENT__FINAL_LAYOUT, oldFinalLayout, finalLayout));
	}
