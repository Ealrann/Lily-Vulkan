		...
		IItemPropertySource
{
	...
	/**
	 * This adds a property descriptor for the Frame Wait Stage feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addFrameWaitStagePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GraphicConfiguration_frameWaitStage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GraphicConfiguration_frameWaitStage_feature", "_UI_GraphicConfiguration_type"),
				 GraphicPackage.Literals.GRAPHIC_CONFIGURATION__FRAME_WAIT_STAGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
