 ...
 * </p>
 * <ul>
 *   <li>{@link org.sheepy.lily.vulkan.extra.graphic.model.impl.MeshRendererImpl#getMeshProvider <em>Mesh Provider</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MeshRendererImpl extends GraphicsPipelineImpl implements MeshRenderer
{
	/**
	...
	{
		return GraphicExtraPackage.Literals.MESH_RENDERER;
	}
		...
		if (meshProvider != null && meshProvider.eIsProxy())
		{
			...
			if (meshProvider != oldMeshProvider)
			{
				if (eNotificationRequired()) eNotify(new ENotificationImpl(this,
						Notification.RESOLVE, GraphicExtraPackage.MESH_RENDERER__MESH_PROVIDER,
	...
	public void setMeshProvider(IMeshProvider newMeshProvider)
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				GraphicExtraPackage.MESH_RENDERER__MESH_PROVIDER, oldMeshProvider, meshProvider));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
		case GraphicExtraPackage.MESH_RENDERER__MESH_PROVIDER:
