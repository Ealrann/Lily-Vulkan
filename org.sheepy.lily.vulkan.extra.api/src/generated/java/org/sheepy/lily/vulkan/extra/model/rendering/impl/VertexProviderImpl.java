 ...
 * </p>
 * <ul>
 *   <li>{@link org.sheepy.lily.vulkan.extra.model.rendering.impl.VertexProviderImpl#getDataSource <em>Data Source</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VertexProviderImpl<T extends Structure> extends BufferDataProviderImpl implements VertexProvider<T>
{
	/**
	...
	public void setDataSource(RenderableDataSource<T> newDataSource)
	{
		if (newDataSource != dataSource) {
			...
			if (newDataSource != null)
				msgs = ((InternalEObject)newDataSource).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RenderingPackage.VERTEX_PROVIDER__DATA_SOURCE, null, msgs);
			msgs = basicSetDataSource(newDataSource, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RenderingPackage.VERTEX_PROVIDER__DATA_SOURCE, newDataSource, newDataSource));
	}
