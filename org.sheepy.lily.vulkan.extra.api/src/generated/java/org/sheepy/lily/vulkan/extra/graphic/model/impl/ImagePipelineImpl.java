 ...
 * </p>
 * <ul>
 *   <li>{@link org.sheepy.lily.vulkan.extra.graphic.model.impl.ImagePipelineImpl#getImage <em>Image</em>}</li>
 *   <li>{@link org.sheepy.lily.vulkan.extra.graphic.model.impl.ImagePipelineImpl#getImageSrcStage <em>Image Src Stage</em>}</li>
 *   <li>{@link org.sheepy.lily.vulkan.extra.graphic.model.impl.ImagePipelineImpl#getImageDstStage <em>Image Dst Stage</em>}</li>
 *   <li>{@link org.sheepy.lily.vulkan.extra.graphic.model.impl.ImagePipelineImpl#getImageSrcAccessMask <em>Image Src Access Mask</em>}</li>
 *   <li>{@link org.sheepy.lily.vulkan.extra.graphic.model.impl.ImagePipelineImpl#getImageDstAccessMask <em>Image Dst Access Mask</em>}</li>
 *   <li>{@link org.sheepy.lily.vulkan.extra.graphic.model.impl.ImagePipelineImpl#getSrcQueue <em>Src Queue</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImagePipelineImpl extends AbstractPipelineImpl implements ImagePipeline
{
	...
	{
		return GraphicExtraPackage.Literals.IMAGE_PIPELINE;
	}
			...
			if (image != oldImage)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GraphicExtraPackage.IMAGE_PIPELINE__IMAGE, oldImage, image));
			}
		}
		return image;
	}
	...
	public void setImageSrcStage(EPipelineStage newImageSrcStage)
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				GraphicExtraPackage.IMAGE_PIPELINE__IMAGE_SRC_STAGE, oldImageSrcStage,
				imageSrcStage));
	}
	...
	public void setImageDstStage(EPipelineStage newImageDstStage)
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				GraphicExtraPackage.IMAGE_PIPELINE__IMAGE_DST_STAGE, oldImageDstStage,
				imageDstStage));
	}
	...
	public EList<EAccess> getImageSrcAccessMask()
	{
		if (imageSrcAccessMask == null)
		{
			imageSrcAccessMask = new EDataTypeUniqueEList<EAccess>(EAccess.class, this,
					GraphicExtraPackage.IMAGE_PIPELINE__IMAGE_SRC_ACCESS_MASK);
		}
	...
	public EList<EAccess> getImageDstAccessMask()
	{
		if (imageDstAccessMask == null)
		{
			imageDstAccessMask = new EDataTypeUniqueEList<EAccess>(EAccess.class, this,
					GraphicExtraPackage.IMAGE_PIPELINE__IMAGE_DST_ACCESS_MASK);
		}
	...
	public AbstractProcess getSrcQueue()
	{
		if (srcQueue != null && srcQueue.eIsProxy())
		{
			...
			if (srcQueue != oldSrcQueue)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GraphicExtraPackage.IMAGE_PIPELINE__SRC_QUEUE, oldSrcQueue, srcQueue));
			}
		}
		return srcQueue;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
		case GraphicExtraPackage.IMAGE_PIPELINE__IMAGE:
		...
		case GraphicExtraPackage.IMAGE_PIPELINE__SRC_QUEUE:
