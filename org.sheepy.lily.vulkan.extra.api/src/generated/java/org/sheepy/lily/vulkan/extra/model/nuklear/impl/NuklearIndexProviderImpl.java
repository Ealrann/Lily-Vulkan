 ...
 * </p>
 * <ul>
 *   <li>{@link org.sheepy.lily.vulkan.extra.model.nuklear.impl.NuklearIndexProviderImpl#getContext <em>Context</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NuklearIndexProviderImpl extends BufferDataProviderImpl<NuklearContext> implements NuklearIndexProvider
{
	 ...
	 * @generated
	 */
	protected NuklearIndexProviderImpl()
	{
		super();
	}
	...
	{
		return NuklearPackage.Literals.NUKLEAR_INDEX_PROVIDER;
	}
		...
		if (context != null && ((EObject)context).eIsProxy())
		{
			...
			if (context != oldContext)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, NuklearPackage.NUKLEAR_INDEX_PROVIDER__CONTEXT, oldContext, context));
			}
		}
		return context;
	}
	...
	public void setContext(NuklearContext newContext)
	{
		...
		context = newContext;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NuklearPackage.NUKLEAR_INDEX_PROVIDER__CONTEXT, oldContext, context));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case NuklearPackage.NUKLEAR_INDEX_PROVIDER__CONTEXT:
