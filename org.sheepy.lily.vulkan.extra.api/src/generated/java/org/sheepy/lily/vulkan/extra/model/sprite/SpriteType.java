 ...
 * <!-- end-user-doc -->
 * @see org.sheepy.lily.vulkan.extra.model.sprite.SpritePackage#getSpriteType()
 * @model
 * @generated
 */
public enum SpriteType implements Enumerator
{
	/**
	 ...
	 * @generated
	 */
	public static final List<SpriteType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	private SpriteType(int value, String name, String literal)
	{
		this.value = value;
		this.name = name;
