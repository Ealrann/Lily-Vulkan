...
public class NuklearFontItemProvider extends IResourceItemProvider
{
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object)
	{
		if (itemPropertyDescriptors == null)
		{
			...
			addFontTextureArrayPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Font Texture Array feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addFontTextureArrayPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NuklearFont_fontTextureArray_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NuklearFont_fontTextureArray_feature", "_UI_NuklearFont_type"),
				 NuklearPackage.Literals.NUKLEAR_FONT__FONT_TEXTURE_ARRAY,
				 true,
				 false,
				 true,
				 null,
