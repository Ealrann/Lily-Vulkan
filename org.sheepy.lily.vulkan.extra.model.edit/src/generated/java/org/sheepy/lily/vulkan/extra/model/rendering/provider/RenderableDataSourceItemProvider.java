...
/**
 * This is the item provider adapter for a {@link org.sheepy.lily.vulkan.extra.model.rendering.RenderableDataSource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RenderableDataSourceItemProvider 
		...
		IItemPropertySource
{
	 ...
	 * @generated
	 */
	public RenderableDataSourceItemProvider(AdapterFactory adapterFactory)
	{
	...
	protected void addPartPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RenderableDataSource_part_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RenderableDataSource_part_feature", "_UI_RenderableDataSource_type"),
				 RenderingPackage.Literals.RENDERABLE_DATA_SOURCE__PART,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns RenderableDataSource.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RenderableDataSource"));
	}
