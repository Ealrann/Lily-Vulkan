		...
		IItemPropertySource
{
	...
	protected void addPickModePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MousePickExtension_pickMode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MousePickExtension_pickMode_feature", "_UI_MousePickExtension_type"),
				 RenderingPackage.Literals.MOUSE_PICK_EXTENSION__PICK_MODE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
	{
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(RenderingPackage.Literals.MOUSE_PICK_EXTENSION__SELECTION);
			childrenFeatures.add(RenderingPackage.Literals.MOUSE_PICK_EXTENSION__FOCUS);
		}
	...
	{
		EMousePickMode labelValue = ((MousePickExtension)object).getPickMode();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_MousePickExtension_type") :
			getString("_UI_MousePickExtension_type") + " " + label;
	}
