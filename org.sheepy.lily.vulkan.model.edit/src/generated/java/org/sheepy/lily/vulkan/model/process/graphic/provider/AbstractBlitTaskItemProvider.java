...
/**
 * This is the item provider adapter for a {@link org.sheepy.lily.vulkan.model.process.graphic.AbstractBlitTask} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractBlitTaskItemProvider 
		...
		IItemPropertySource
{
	 ...
	 * @generated
	 */
	public AbstractBlitTaskItemProvider(AdapterFactory adapterFactory)
	{
	...
	protected void addFilterPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AbstractBlitTask_filter_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AbstractBlitTask_filter_feature", "_UI_AbstractBlitTask_type"),
				 GraphicPackage.Literals.ABSTRACT_BLIT_TASK__FILTER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addClearColorPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AbstractBlitTask_clearColor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AbstractBlitTask_clearColor_feature", "_UI_AbstractBlitTask_type"),
				 GraphicPackage.Literals.ABSTRACT_BLIT_TASK__CLEAR_COLOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addSrcImagePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AbstractBlitTask_srcImage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AbstractBlitTask_srcImage_feature", "_UI_AbstractBlitTask_type"),
	...
	{
		String label = ((AbstractBlitTask)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractBlitTask_type") :
			getString("_UI_AbstractBlitTask_type") + " " + label;
	}
