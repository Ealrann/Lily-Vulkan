...
/**
 * This is the item provider adapter for a {@link org.sheepy.lily.vulkan.model.process.graphic.AttachmentDescriptor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttachmentDescriptorItemProvider 
		...
		IItemPropertySource
{
	 ...
	 * @generated
	 */
	public AttachmentDescriptorItemProvider(AdapterFactory adapterFactory)
	{
	...
	protected void addAttachmentPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AttachmentDescriptor_attachment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AttachmentDescriptor_attachment_feature", "_UI_AttachmentDescriptor_type"),
				 GraphicPackage.Literals.ATTACHMENT_DESCRIPTOR__ATTACHMENT,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns AttachmentDescriptor.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AttachmentDescriptor"));
	}
	...
	{
		String label = ((AttachmentDescriptor)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AttachmentDescriptor_type") :
			getString("_UI_AttachmentDescriptor_type") + " " + label;
	}
