...
/**
 * This is the item provider adapter for a {@link org.sheepy.lily.vulkan.model.process.FetchBuffer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FetchBufferItemProvider 
		...
		IItemPropertySource
{
	 ...
	 * @generated
	 */
	public FetchBufferItemProvider(AdapterFactory adapterFactory)
	{
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FetchBuffer"));
	}
	...
	{
		String label = ((FetchBuffer)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_FetchBuffer_type") :
			getString("_UI_FetchBuffer_type") + " " + label;
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection)
	{
		...
		boolean qualify =
			childFeature == ProcessPackage.Literals.FETCH_BUFFER__BUFFER_REFERENCE;
