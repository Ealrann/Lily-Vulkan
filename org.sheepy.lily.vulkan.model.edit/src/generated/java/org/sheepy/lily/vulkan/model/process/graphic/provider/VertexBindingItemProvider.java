		...
		ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	protected void addBufferPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getResourceLocator(), getString("_UI_VertexBinding_buffer_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_VertexBinding_buffer_feature",
						"_UI_VertexBinding_type"),
				GraphicPackage.Literals.VERTEX_BINDING__BUFFER, true, false, true, null, null,
				null));
	}
	...
	protected void addOffsetPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(), getString("_UI_VertexBinding_offset_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_VertexBinding_offset_feature",
						"_UI_VertexBinding_type"),
				GraphicPackage.Literals.VERTEX_BINDING__OFFSET, true, false, false,
	...
	{
		VertexBinding vertexBinding = (VertexBinding) object;
		return getString("_UI_VertexBinding_type") + " " + vertexBinding.getOffset();
	}
