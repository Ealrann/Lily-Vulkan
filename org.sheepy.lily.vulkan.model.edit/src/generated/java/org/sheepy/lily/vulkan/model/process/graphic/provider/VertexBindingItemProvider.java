		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VertexBinding_buffer_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VertexBinding_buffer_feature", "_UI_VertexBinding_type"),
				 GraphicPackage.Literals.VERTEX_BINDING__BUFFER,
				 true,
				 false,
				 true,
				 null,
