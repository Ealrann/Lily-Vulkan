...
/**
 * This is the item provider adapter for a {@link org.sheepy.lily.vulkan.model.vulkanresource.ImageDescriptor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImageDescriptorItemProvider 
		...
		IItemPropertySource
{
	 ...
	 * @generated
	 */
	public ImageDescriptorItemProvider(AdapterFactory adapterFactory)
	{
	...
	protected void addImagesPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ImageDescriptor_images_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ImageDescriptor_images_feature", "_UI_ImageDescriptor_type"),
				 VulkanResourcePackage.Literals.IMAGE_DESCRIPTOR__IMAGES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addSamplerPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ImageDescriptor_sampler_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ImageDescriptor_sampler_feature", "_UI_ImageDescriptor_type"),
				 VulkanResourcePackage.Literals.IMAGE_DESCRIPTOR__SAMPLER,
				 true,
				 false,
				 true,
				 null,
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ImageDescriptor"));
	}
	...
	{
		String label = ((ImageDescriptor)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ImageDescriptor_type") :
			getString("_UI_ImageDescriptor_type") + " " + label;
	}
