	...
	protected void addBufferPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BindIndexBuffer_buffer_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BindIndexBuffer_buffer_feature", "_UI_BindIndexBuffer_type"),
				 GraphicPackage.Literals.BIND_INDEX_BUFFER__BUFFER,
				 true,
				 false,
				 true,
				 null,
