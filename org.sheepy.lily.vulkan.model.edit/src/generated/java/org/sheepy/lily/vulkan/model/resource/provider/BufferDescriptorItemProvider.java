 ...
 * @generated
 */
public class BufferDescriptorItemProvider 
		...
		IItemPropertySource
{
	 ...
	 * @generated
	 */
	public BufferDescriptorItemProvider(AdapterFactory adapterFactory)
	{
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
	{
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(ResourcePackage.Literals.BUFFER_DESCRIPTOR__BUFFER_REFERENCE);
		}
	...
	/**
	 * This returns BufferDescriptor.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BufferDescriptor"));
	}
	...
	{
		String label = ((BufferDescriptor)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_BufferDescriptor_type") :
			getString("_UI_BufferDescriptor_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add
			(createChildParameter
				(ResourcePackage.Literals.BUFFER_DESCRIPTOR__BUFFER_REFERENCE,
