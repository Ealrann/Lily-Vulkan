...
public final class ImageBackend
{
									  ...
									  Collection<EAccess> dstAccessMask)
	{
		...
		barrierInfo.srcAccessMask(getAccessMask(srcAccessMask));
		barrierInfo.dstAccessMask(getAccessMask(dstAccessMask));
	...
	private static int getAccessMask(final Collection<EAccess> accesses)
	{
		int res = 0;
