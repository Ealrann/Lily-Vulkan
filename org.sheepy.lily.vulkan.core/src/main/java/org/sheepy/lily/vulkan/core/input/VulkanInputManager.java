...
public final class VulkanInputManager extends Notifier<IInputManager.Features> implements IVulkanInputManager
{
	...
	private final LongConsumer openListener = windowPtr -> load.run();
	...
	public void connect(Window window)
	{
		...
		window.listen(openListener, IWindow.Features.Open);
	}
	...
	public void disconnect()
	{
		if (window != null)
		{
			window.sulk(openListener, IWindow.Features.Open);
			dispose();
			this.window = null;
		}
	}
