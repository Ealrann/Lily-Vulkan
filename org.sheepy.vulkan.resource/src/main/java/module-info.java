...
module org.sheepy.vulkan.resource
{
	...
	provides IServiceAdapter with ShaderAdapter, TextureAdapter, DepthImageAdapter,
			FileResourceAdapter, ModuleResourceAdapter, PushConstantAdapter, DescriptorSetAdapter;
}