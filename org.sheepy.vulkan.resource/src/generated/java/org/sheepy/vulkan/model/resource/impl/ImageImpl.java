 ...
 *   <li>{@link org.sheepy.vulkan.model.resource.impl.ImageImpl#getUsage <em>Usage</em>}</li>
...
public class ImageImpl extends MinimalEObjectImpl.Container implements Image
{
	...
	public void setUsage(int newUsage)
	{
		...
		usage = newUsage;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcePackage.IMAGE__USAGE, oldUsage, usage));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			...
			case ResourcePackage.IMAGE__FORMAT:
				return getFormat();
			case ResourcePackage.IMAGE__USAGE:
				return getUsage();
