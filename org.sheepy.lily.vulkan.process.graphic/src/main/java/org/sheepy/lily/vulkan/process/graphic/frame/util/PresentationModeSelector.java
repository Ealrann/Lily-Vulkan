...
public class PresentationModeSelector
{
	...
	{
		final var presentWhenVBlank = configuration.presentWhenVBlank();
		final var acquireWaitForVBlank = configuration.acquireWaitForVBlank();
	...
	private static EPresentMode get(final int value)
	{
		for (final var mode : EPresentMode.values())
		{
