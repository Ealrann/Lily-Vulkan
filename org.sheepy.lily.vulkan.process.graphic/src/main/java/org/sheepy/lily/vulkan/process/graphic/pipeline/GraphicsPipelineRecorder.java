...
@Allocation(context = ProcessContext.class, activator = GraphicsPipeline.FeatureIDs.RECORD)
@AllocationDependency(features = GraphicsPipeline.FeatureIDs.TASK_PKGS, type = IRecordableAdapter.class)
