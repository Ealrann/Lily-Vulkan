...
public final class PhysicalSurfaceAllocation implements IPhysicalSurfaceAllocation, IAdapter
{
									  ...
									  final ProcessContext context)
	{
		...
		colorDomain = loadColorDomain(vkPhysicalDevice, physicalSurface.colorDomain());
	}
	...
	private VkColorDomain loadColorDomain(VkPhysicalDevice device, ColorDomain colorDomain)
	{
		...
		final var vkColorDomain = new VkColorDomain(colorDomain.format().value(),
													colorDomain.colorSpace().value());
