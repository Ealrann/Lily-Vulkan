...
@AllocationDependency(parent = GraphicConfiguration.class, features = GraphicConfiguration.FeatureIDs.IMAGE_VIEWS, type = ImageViewAllocation.class)
@AllocationDependency(parent = GraphicConfiguration.class, features = GraphicConfiguration.FeatureIDs.RENDER_PASS, type = RenderPassAllocation.class)
public final class FramebufferAllocation implements IFramebufferManager, IAdapter
{
