...
@Allocation
@AllocationDependency(features = {BindVertexBuffer.FeatureIDs.VERTEX_BINDINGS, VertexBinding.FeatureIDs.BUFFER}, type = IVulkanBufferAllocation.class)
public final class BindVertexBuferRecorder implements IRecordableAdapter
{
	...
	public void record(RecordContext context)
	{
		...
		final int firstBinding = task.firstBinding();
