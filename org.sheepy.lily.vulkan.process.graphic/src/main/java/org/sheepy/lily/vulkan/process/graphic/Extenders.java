...
import org.sheepy.lily.vulkan.process.graphic.execution.GraphicAcquirerAllocation;
...
import org.sheepy.lily.vulkan.process.graphic.pipeline.GraphicsPipelineAllocationNode;
import org.sheepy.lily.vulkan.process.graphic.pipeline.GraphicsPipelineRecorder;
import org.sheepy.lily.vulkan.process.graphic.pipeline.SubpassAllocation;
import org.sheepy.lily.vulkan.process.graphic.pipeline.SubpassRecorder;
import org.sheepy.lily.vulkan.process.graphic.pipeline.task.BlitTaskRecorder;
import org.sheepy.lily.vulkan.process.graphic.pipeline.task.BlitToSwapImageRecorder;
import org.sheepy.lily.vulkan.process.graphic.pipeline.task.BindIndexBufferRecorder;
import org.sheepy.lily.vulkan.process.graphic.pipeline.task.BindVertexBuferRecorder;
import org.sheepy.lily.vulkan.process.graphic.pipeline.task.DrawIndexedRecorder;
import org.sheepy.lily.vulkan.process.graphic.pipeline.task.DrawRecorder;
import org.sheepy.lily.vulkan.process.graphic.pipeline.task.SetScissorRecorder;
...
import org.sheepy.lily.vulkan.process.graphic.renderpass.RenderPassAdapter;
...
import org.sheepy.lily.vulkan.process.graphic.scene.CompositorSubpassProvider;
...
public class Extenders implements IAdapterProvider
{
	...
	public List<Class<? extends IAdapter>> classifiers()
	{
		return List.of(GraphicProcessAllocation.class,
					   ...
					   CompositorSubpassProvider.class,
					   ...
					   GraphicAcquirerAllocation.class);
	}
