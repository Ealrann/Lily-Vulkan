...
@AllocationDependency(features = AbstractBlitTask.FeatureIDs.SRC_IMAGE, type = IVkImageAllocation.class)
@AllocationDependency(features = BlitTask.FeatureIDs.DST_IMAGE, type = IVkImageAllocation.class)
