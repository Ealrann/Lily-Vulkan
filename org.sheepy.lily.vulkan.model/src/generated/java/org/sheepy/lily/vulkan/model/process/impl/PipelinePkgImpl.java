 ...
 * @generated
 */
public class PipelinePkgImpl extends MinimalEObjectImpl.Container implements PipelinePkg
{
	/**
	...
	public EList<IPipeline> getPipelines()
	{
		if (pipelines == null)
		{
			pipelines = new EObjectContainmentEList<IPipeline>(IPipeline.class, this,
					ProcessPackage.PIPELINE_PKG__PIPELINES);
		}
		return pipelines;
	}
