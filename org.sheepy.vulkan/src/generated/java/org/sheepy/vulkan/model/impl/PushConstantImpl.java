 ...
 * </p>
 * <ul>
 *   <li>{@link org.sheepy.vulkan.model.impl.PushConstantImpl#getSize <em>Size</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.impl.PushConstantImpl#getStage <em>Stage</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PushConstantImpl extends MinimalEObjectImpl.Container implements PushConstant
{
	...
	{
		return VulkanPackage.Literals.PUSH_CONSTANT;
	}
	...
	public void setSize(int newSize)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.PUSH_CONSTANT__SIZE, oldSize, size));
	}
	...
	public void setStage(EPipelineStage newStage)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.PUSH_CONSTANT__STAGE, oldStage, stage));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case VulkanPackage.PUSH_CONSTANT__SIZE:
				return getSize();
			case VulkanPackage.PUSH_CONSTANT__STAGE:
				return getStage();
		}
