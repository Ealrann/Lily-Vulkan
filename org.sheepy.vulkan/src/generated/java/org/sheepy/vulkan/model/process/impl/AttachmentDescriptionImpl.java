 ...
 * </p>
 * <ul>
 *   <li>{@link org.sheepy.vulkan.model.process.impl.AttachmentDescriptionImpl#isStencil <em>Stencil</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.process.impl.AttachmentDescriptionImpl#getSamples <em>Samples</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.process.impl.AttachmentDescriptionImpl#getLoadOp <em>Load Op</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.process.impl.AttachmentDescriptionImpl#getStoreOp <em>Store Op</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.process.impl.AttachmentDescriptionImpl#getStencilLoadOp <em>Stencil Load Op</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.process.impl.AttachmentDescriptionImpl#getStencilStoreOp <em>Stencil Store Op</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.process.impl.AttachmentDescriptionImpl#getInitialLayout <em>Initial Layout</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.process.impl.AttachmentDescriptionImpl#getFinalLayout <em>Final Layout</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.process.impl.AttachmentDescriptionImpl#getRefLayout <em>Ref Layout</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttachmentDescriptionImpl extends MinimalEObjectImpl.Container implements AttachmentDescription
{
	...
	{
		return ProcessPackage.Literals.ATTACHMENT_DESCRIPTION;
	}
	...
	public void setStencil(boolean newStencil)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ATTACHMENT_DESCRIPTION__STENCIL, oldStencil, stencil));
	}
	...
	public void setSamples(ESampleCount newSamples)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ATTACHMENT_DESCRIPTION__SAMPLES, oldSamples, samples));
	}
	...
	public void setLoadOp(EAttachmentLoadOp newLoadOp)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ATTACHMENT_DESCRIPTION__LOAD_OP, oldLoadOp, loadOp));
	}
	...
	public void setStoreOp(EAttachmentStoreOp newStoreOp)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ATTACHMENT_DESCRIPTION__STORE_OP, oldStoreOp, storeOp));
	}
	...
	public void setStencilLoadOp(EAttachmentLoadOp newStencilLoadOp)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ATTACHMENT_DESCRIPTION__STENCIL_LOAD_OP, oldStencilLoadOp, stencilLoadOp));
	}
	...
	public void setStencilStoreOp(EAttachmentStoreOp newStencilStoreOp)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ATTACHMENT_DESCRIPTION__STENCIL_STORE_OP, oldStencilStoreOp, stencilStoreOp));
	}
	...
	public void setInitialLayout(EImageLayout newInitialLayout)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ATTACHMENT_DESCRIPTION__INITIAL_LAYOUT, oldInitialLayout, initialLayout));
	}
	...
	public void setFinalLayout(EImageLayout newFinalLayout)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ATTACHMENT_DESCRIPTION__FINAL_LAYOUT, oldFinalLayout, finalLayout));
	}
	...
	public void setRefLayout(EImageLayout newRefLayout)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.ATTACHMENT_DESCRIPTION__REF_LAYOUT, oldRefLayout, refLayout));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case ProcessPackage.ATTACHMENT_DESCRIPTION__STENCIL:
				return isStencil();
			case ProcessPackage.ATTACHMENT_DESCRIPTION__SAMPLES:
				return getSamples();
			case ProcessPackage.ATTACHMENT_DESCRIPTION__LOAD_OP:
				return getLoadOp();
			case ProcessPackage.ATTACHMENT_DESCRIPTION__STORE_OP:
				return getStoreOp();
			case ProcessPackage.ATTACHMENT_DESCRIPTION__STENCIL_LOAD_OP:
				return getStencilLoadOp();
			case ProcessPackage.ATTACHMENT_DESCRIPTION__STENCIL_STORE_OP:
				return getStencilStoreOp();
			case ProcessPackage.ATTACHMENT_DESCRIPTION__INITIAL_LAYOUT:
				return getInitialLayout();
			case ProcessPackage.ATTACHMENT_DESCRIPTION__FINAL_LAYOUT:
				return getFinalLayout();
			case ProcessPackage.ATTACHMENT_DESCRIPTION__REF_LAYOUT:
				return getRefLayout();
		}
