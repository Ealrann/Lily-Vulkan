 ...
 * </p>
 * <ul>
 *   <li>{@link org.sheepy.vulkan.model.impl.AbstractImageBarrierImpl#getTransitions <em>Transitions</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractImageBarrierImpl extends PipelineBarrierImpl implements AbstractImageBarrier
{
	...
	{
		return VulkanPackage.Literals.ABSTRACT_IMAGE_BARRIER;
	}
	...
	public EList<ImageTransition> getTransitions()
	{
		if (transitions == null)
		{
			transitions = new EObjectContainmentEList<ImageTransition>(ImageTransition.class, this, VulkanPackage.ABSTRACT_IMAGE_BARRIER__TRANSITIONS);
		}
		return transitions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case VulkanPackage.ABSTRACT_IMAGE_BARRIER__TRANSITIONS:
