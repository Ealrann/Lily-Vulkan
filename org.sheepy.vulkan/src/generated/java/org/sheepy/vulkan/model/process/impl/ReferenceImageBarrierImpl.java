 ...
 * </p>
 * <ul>
 *   <li>{@link org.sheepy.vulkan.model.process.impl.ReferenceImageBarrierImpl#getImageId <em>Image Id</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.process.impl.ReferenceImageBarrierImpl#getMipLevels <em>Mip Levels</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.process.impl.ReferenceImageBarrierImpl#getImageFormat <em>Image Format</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReferenceImageBarrierImpl extends AbstractImageBarrierImpl implements ReferenceImageBarrier
{
	...
	{
		return ProcessPackage.Literals.REFERENCE_IMAGE_BARRIER;
	}
	...
	public void setImageId(long newImageId)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.REFERENCE_IMAGE_BARRIER__IMAGE_ID, oldImageId, imageId));
	}
	...
	public void setMipLevels(int newMipLevels)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.REFERENCE_IMAGE_BARRIER__MIP_LEVELS, oldMipLevels, mipLevels));
	}
	...
	public void setImageFormat(int newImageFormat)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.REFERENCE_IMAGE_BARRIER__IMAGE_FORMAT, oldImageFormat, imageFormat));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case ProcessPackage.REFERENCE_IMAGE_BARRIER__IMAGE_ID:
				return getImageId();
			case ProcessPackage.REFERENCE_IMAGE_BARRIER__MIP_LEVELS:
				return getMipLevels();
			case ProcessPackage.REFERENCE_IMAGE_BARRIER__IMAGE_FORMAT:
