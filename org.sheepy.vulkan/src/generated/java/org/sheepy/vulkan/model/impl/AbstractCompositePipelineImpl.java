 ...
 * </p>
 * <ul>
 *   <li>{@link org.sheepy.vulkan.model.impl.AbstractCompositePipelineImpl#getPipelines <em>Pipelines</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractCompositePipelineImpl extends AbstractPipelineImpl implements AbstractCompositePipeline
{
	...
	{
		return VulkanPackage.Literals.ABSTRACT_COMPOSITE_PIPELINE;
	}
	...
	public EList<AbstractPipeline> getPipelines()
	{
		if (pipelines == null)
		{
			pipelines = new EObjectContainmentEList<AbstractPipeline>(AbstractPipeline.class, this, VulkanPackage.ABSTRACT_COMPOSITE_PIPELINE__PIPELINES);
		}
		return pipelines;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case VulkanPackage.ABSTRACT_COMPOSITE_PIPELINE__PIPELINES:
