 ...
 * </p>
 * <ul>
 *   <li>{@link org.sheepy.vulkan.model.impl.ImagePipelineImpl#getImage <em>Image</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.impl.ImagePipelineImpl#getImageSrcStage <em>Image Src Stage</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.impl.ImagePipelineImpl#getImageDstStage <em>Image Dst Stage</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.impl.ImagePipelineImpl#getImageSrcAccess <em>Image Src Access</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.impl.ImagePipelineImpl#getImageDstAccess <em>Image Dst Access</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImagePipelineImpl extends AbstractPipelineImpl implements ImagePipeline
{
	...
	{
		return VulkanPackage.Literals.IMAGE_PIPELINE;
	}
		...
		if (image != null && image.eIsProxy())
		{
			...
			if (image != oldImage)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VulkanPackage.IMAGE_PIPELINE__IMAGE, oldImage, image));
			}
		}
		return image;
	}
	...
	public void setImage(Image newImage)
	{
		...
		image = newImage;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.IMAGE_PIPELINE__IMAGE, oldImage, image));
	}
	...
	public void setImageSrcStage(EPipelineStage newImageSrcStage)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.IMAGE_PIPELINE__IMAGE_SRC_STAGE, oldImageSrcStage, imageSrcStage));
	}
	...
	public void setImageDstStage(EPipelineStage newImageDstStage)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.IMAGE_PIPELINE__IMAGE_DST_STAGE, oldImageDstStage, imageDstStage));
	}
	...
	public void setImageSrcAccess(int newImageSrcAccess)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.IMAGE_PIPELINE__IMAGE_SRC_ACCESS, oldImageSrcAccess, imageSrcAccess));
	}
	...
	public void setImageDstAccess(int newImageDstAccess)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.IMAGE_PIPELINE__IMAGE_DST_ACCESS, oldImageDstAccess, imageDstAccess));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case VulkanPackage.IMAGE_PIPELINE__IMAGE:
				if (resolve) return getImage();
				return basicGetImage();
			case VulkanPackage.IMAGE_PIPELINE__IMAGE_SRC_STAGE:
				return getImageSrcStage();
			case VulkanPackage.IMAGE_PIPELINE__IMAGE_DST_STAGE:
				return getImageDstStage();
			case VulkanPackage.IMAGE_PIPELINE__IMAGE_SRC_ACCESS:
				return getImageSrcAccess();
			case VulkanPackage.IMAGE_PIPELINE__IMAGE_DST_ACCESS:
