 ...
 * </p>
 * <ul>
 *   <li>{@link org.sheepy.vulkan.model.impl.RenderPassInfoImpl#getAttachments <em>Attachments</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.impl.RenderPassInfoImpl#getDependencies <em>Dependencies</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.impl.RenderPassInfoImpl#getBindPoint <em>Bind Point</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RenderPassInfoImpl extends MinimalEObjectImpl.Container implements RenderPassInfo
{
	...
	{
		return VulkanPackage.Literals.RENDER_PASS_INFO;
	}
	...
	public EList<AttachmentDescription> getAttachments()
	{
		if (attachments == null)
		{
			attachments = new EObjectContainmentEList<AttachmentDescription>(AttachmentDescription.class, this, VulkanPackage.RENDER_PASS_INFO__ATTACHMENTS);
		}
		return attachments;
	}
	...
	public EList<SubpassDependency> getDependencies()
	{
		...
		{
			dependencies = new EObjectContainmentEList<SubpassDependency>(SubpassDependency.class, this, VulkanPackage.RENDER_PASS_INFO__DEPENDENCIES);
		}
		return dependencies;
	}
	...
	public void setBindPoint(int newBindPoint)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.RENDER_PASS_INFO__BIND_POINT, oldBindPoint, bindPoint));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case VulkanPackage.RENDER_PASS_INFO__ATTACHMENTS:
				return ((InternalEList<?>)getAttachments()).basicRemove(otherEnd, msgs);
			case VulkanPackage.RENDER_PASS_INFO__DEPENDENCIES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			...
			case VulkanPackage.RENDER_PASS_INFO__BIND_POINT:
				return getBindPoint();
		}
