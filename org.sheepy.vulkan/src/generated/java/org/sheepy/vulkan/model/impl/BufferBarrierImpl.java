 ...
 * </p>
 * <ul>
 *   <li>{@link org.sheepy.vulkan.model.impl.BufferBarrierImpl#getBuffer <em>Buffer</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.impl.BufferBarrierImpl#getSrcAccess <em>Src Access</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.impl.BufferBarrierImpl#getDstAccess <em>Dst Access</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BufferBarrierImpl extends PipelineBarrierImpl implements BufferBarrier
{
	...
	{
		return VulkanPackage.Literals.BUFFER_BARRIER;
	}
		...
		if (buffer != null && buffer.eIsProxy())
		{
			...
			if (buffer != oldBuffer)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VulkanPackage.BUFFER_BARRIER__BUFFER, oldBuffer, buffer));
			}
		}
		return buffer;
	}
	...
	public void setBuffer(Buffer newBuffer)
	{
		...
		buffer = newBuffer;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.BUFFER_BARRIER__BUFFER, oldBuffer, buffer));
	}
	...
	public void setSrcAccess(int newSrcAccess)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.BUFFER_BARRIER__SRC_ACCESS, oldSrcAccess, srcAccess));
	}
	...
	public void setDstAccess(int newDstAccess)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.BUFFER_BARRIER__DST_ACCESS, oldDstAccess, dstAccess));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case VulkanPackage.BUFFER_BARRIER__BUFFER:
				if (resolve) return getBuffer();
				return basicGetBuffer();
			case VulkanPackage.BUFFER_BARRIER__SRC_ACCESS:
				return getSrcAccess();
			case VulkanPackage.BUFFER_BARRIER__DST_ACCESS:
				return getDstAccess();
		}
