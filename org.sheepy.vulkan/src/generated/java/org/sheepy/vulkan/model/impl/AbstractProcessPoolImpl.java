 ...
 * </p>
 * <ul>
 *   <li>{@link org.sheepy.vulkan.model.impl.AbstractProcessPoolImpl#getProcesses <em>Processes</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.impl.AbstractProcessPoolImpl#getResources <em>Resources</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.impl.AbstractProcessPoolImpl#isResetAllowed <em>Reset Allowed</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractProcessPoolImpl<T extends AbstractProcess> extends MinimalEObjectImpl.Container implements AbstractProcessPool<T>
{
	...
	{
		return VulkanPackage.Literals.ABSTRACT_PROCESS_POOL;
	}
	...
	public EList<T> getProcesses()
	{
		if (processes == null)
		{
			processes = new EObjectContainmentEList<T>(AbstractProcess.class, this, VulkanPackage.ABSTRACT_PROCESS_POOL__PROCESSES);
		}
		return processes;
	}
	...
	public EList<Resource> getResources()
	{
		if (resources == null)
		{
			resources = new EObjectContainmentEList<Resource>(Resource.class, this, VulkanPackage.ABSTRACT_PROCESS_POOL__RESOURCES);
		}
		return resources;
	}
	...
	public void setResetAllowed(boolean newResetAllowed)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.ABSTRACT_PROCESS_POOL__RESET_ALLOWED, oldResetAllowed, resetAllowed));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case VulkanPackage.ABSTRACT_PROCESS_POOL__PROCESSES:
				return ((InternalEList<?>)getProcesses()).basicRemove(otherEnd, msgs);
			case VulkanPackage.ABSTRACT_PROCESS_POOL__RESOURCES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			...
			case VulkanPackage.ABSTRACT_PROCESS_POOL__RESOURCES:
				return getResources();
			case VulkanPackage.ABSTRACT_PROCESS_POOL__RESET_ALLOWED:
