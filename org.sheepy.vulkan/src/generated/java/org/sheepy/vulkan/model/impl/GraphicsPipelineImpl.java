 ...
 * </p>
 * <ul>
 *   <li>{@link org.sheepy.vulkan.model.impl.GraphicsPipelineImpl#getShaders <em>Shaders</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class GraphicsPipelineImpl extends AbstractPipelineImpl implements GraphicsPipeline
{
	...
	{
		return VulkanPackage.Literals.GRAPHICS_PIPELINE;
	}
	...
	public EList<Shader> getShaders()
	{
		if (shaders == null)
		{
			shaders = new EObjectResolvingEList<Shader>(Shader.class, this, VulkanPackage.GRAPHICS_PIPELINE__SHADERS);
		}
		return shaders;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case VulkanPackage.GRAPHICS_PIPELINE__SHADERS:
				return getShaders();
		}
