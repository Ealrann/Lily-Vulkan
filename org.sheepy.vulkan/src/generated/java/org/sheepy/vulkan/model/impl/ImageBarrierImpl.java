 ...
 * </p>
 * <ul>
 *   <li>{@link org.sheepy.vulkan.model.impl.ImageBarrierImpl#getImage <em>Image</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImageBarrierImpl extends AbstractImageBarrierImpl implements ImageBarrier
{
	...
	{
		return VulkanPackage.Literals.IMAGE_BARRIER;
	}
		...
		if (image != null && image.eIsProxy())
		{
			...
			if (image != oldImage)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VulkanPackage.IMAGE_BARRIER__IMAGE, oldImage, image));
			}
		}
		return image;
	}
	...
	public void setImage(Image newImage)
	{
		...
		image = newImage;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.IMAGE_BARRIER__IMAGE, oldImage, image));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case VulkanPackage.IMAGE_BARRIER__IMAGE:
