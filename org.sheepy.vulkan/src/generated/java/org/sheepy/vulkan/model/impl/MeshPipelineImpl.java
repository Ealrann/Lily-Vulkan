 ...
 * </p>
 * <ul>
 *   <li>{@link org.sheepy.vulkan.model.impl.MeshPipelineImpl#getMesh <em>Mesh</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MeshPipelineImpl extends GraphicsPipelineImpl implements MeshPipeline
{
	...
	{
		return VulkanPackage.Literals.MESH_PIPELINE;
	}
		...
		if (mesh != null && mesh.eIsProxy())
		{
			...
			if (mesh != oldMesh)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VulkanPackage.MESH_PIPELINE__MESH, oldMesh, mesh));
			}
		}
		return mesh;
	}
	...
	public void setMesh(MeshBuffer newMesh)
	{
		...
		mesh = newMesh;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.MESH_PIPELINE__MESH, oldMesh, mesh));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case VulkanPackage.MESH_PIPELINE__MESH:
