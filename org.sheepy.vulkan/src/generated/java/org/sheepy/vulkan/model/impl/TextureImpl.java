 ...
 * </p>
 * <ul>
 *   <li>{@link org.sheepy.vulkan.model.impl.TextureImpl#getFile <em>File</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.impl.TextureImpl#isMipmapEnabled <em>Mipmap Enabled</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TextureImpl extends MinimalEObjectImpl.Container implements Texture
{
	...
	{
		return VulkanPackage.Literals.TEXTURE;
	}
	...
	public NotificationChain basicSetFile(PathResource newFile, NotificationChain msgs)
	{
		...
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, VulkanPackage.TEXTURE__FILE, oldFile, newFile);
	...
	public void setFile(PathResource newFile)
	{
		if (newFile != file)
		{
			...
			if (file != null)
				msgs = ((InternalEObject)file).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - VulkanPackage.TEXTURE__FILE, null, msgs);
			if (newFile != null)
				msgs = ((InternalEObject)newFile).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - VulkanPackage.TEXTURE__FILE, null, msgs);
			msgs = basicSetFile(newFile, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.TEXTURE__FILE, newFile, newFile));
	}
	...
	public void setMipmapEnabled(boolean newMipmapEnabled)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.TEXTURE__MIPMAP_ENABLED, oldMipmapEnabled, mipmapEnabled));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case VulkanPackage.TEXTURE__FILE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case VulkanPackage.TEXTURE__FILE:
				return getFile();
			case VulkanPackage.TEXTURE__MIPMAP_ENABLED:
