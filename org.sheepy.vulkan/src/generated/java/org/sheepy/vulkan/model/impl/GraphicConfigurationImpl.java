 ...
 * </p>
 * <ul>
 *   <li>{@link org.sheepy.vulkan.model.impl.GraphicConfigurationImpl#isClearBeforeRender <em>Clear Before Render</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.impl.GraphicConfigurationImpl#getPresentationMode <em>Presentation Mode</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.impl.GraphicConfigurationImpl#getSwapImageUsage <em>Swap Image Usage</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.impl.GraphicConfigurationImpl#getFrameWaitStage <em>Frame Wait Stage</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.impl.GraphicConfigurationImpl#getColorDomain <em>Color Domain</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.impl.GraphicConfigurationImpl#getRasterizerCullMode <em>Rasterizer Cull Mode</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.impl.GraphicConfigurationImpl#getRasterizerFrontFace <em>Rasterizer Front Face</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GraphicConfigurationImpl extends MinimalEObjectImpl.Container implements GraphicConfiguration
{
	...
	{
		return VulkanPackage.Literals.GRAPHIC_CONFIGURATION;
	}
	...
	public void setClearBeforeRender(boolean newClearBeforeRender)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.GRAPHIC_CONFIGURATION__CLEAR_BEFORE_RENDER, oldClearBeforeRender, clearBeforeRender));
	}
	...
	public void setPresentationMode(EPresentMode newPresentationMode)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.GRAPHIC_CONFIGURATION__PRESENTATION_MODE, oldPresentationMode, presentationMode));
	}
	...
	public void setSwapImageUsage(int newSwapImageUsage)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.GRAPHIC_CONFIGURATION__SWAP_IMAGE_USAGE, oldSwapImageUsage, swapImageUsage));
	}
	...
	public void setFrameWaitStage(EPipelineStage newFrameWaitStage)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.GRAPHIC_CONFIGURATION__FRAME_WAIT_STAGE, oldFrameWaitStage, frameWaitStage));
	}
	...
	public NotificationChain basicSetColorDomain(ColorDomain newColorDomain, NotificationChain msgs)
	{
		...
		if (eNotificationRequired())
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, VulkanPackage.GRAPHIC_CONFIGURATION__COLOR_DOMAIN, oldColorDomain, newColorDomain);
	...
	public void setColorDomain(ColorDomain newColorDomain)
	{
		if (newColorDomain != colorDomain)
		{
			...
			if (colorDomain != null)
				msgs = ((InternalEObject)colorDomain).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - VulkanPackage.GRAPHIC_CONFIGURATION__COLOR_DOMAIN, null, msgs);
			if (newColorDomain != null)
				msgs = ((InternalEObject)newColorDomain).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - VulkanPackage.GRAPHIC_CONFIGURATION__COLOR_DOMAIN, null, msgs);
			msgs = basicSetColorDomain(newColorDomain, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.GRAPHIC_CONFIGURATION__COLOR_DOMAIN, newColorDomain, newColorDomain));
	}
	...
	public void setRasterizerCullMode(ECullMode newRasterizerCullMode)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.GRAPHIC_CONFIGURATION__RASTERIZER_CULL_MODE, oldRasterizerCullMode, rasterizerCullMode));
	}
	...
	public void setRasterizerFrontFace(EFrontFace newRasterizerFrontFace)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.GRAPHIC_CONFIGURATION__RASTERIZER_FRONT_FACE, oldRasterizerFrontFace, rasterizerFrontFace));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case VulkanPackage.GRAPHIC_CONFIGURATION__COLOR_DOMAIN:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case VulkanPackage.GRAPHIC_CONFIGURATION__CLEAR_BEFORE_RENDER:
				return isClearBeforeRender();
			case VulkanPackage.GRAPHIC_CONFIGURATION__PRESENTATION_MODE:
				return getPresentationMode();
			case VulkanPackage.GRAPHIC_CONFIGURATION__SWAP_IMAGE_USAGE:
				return getSwapImageUsage();
			case VulkanPackage.GRAPHIC_CONFIGURATION__FRAME_WAIT_STAGE:
				return getFrameWaitStage();
			case VulkanPackage.GRAPHIC_CONFIGURATION__COLOR_DOMAIN:
				return getColorDomain();
			case VulkanPackage.GRAPHIC_CONFIGURATION__RASTERIZER_CULL_MODE:
				return getRasterizerCullMode();
			case VulkanPackage.GRAPHIC_CONFIGURATION__RASTERIZER_FRONT_FACE:
