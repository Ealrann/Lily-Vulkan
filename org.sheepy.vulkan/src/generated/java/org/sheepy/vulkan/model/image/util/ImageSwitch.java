/**
 */
package org.sheepy.vulkan.model.image.util;
...
public class ImageSwitch<T> extends Switch<T>
{
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			case ImagePackage.SAMPLER_INFO:
			{
				SamplerInfo samplerInfo = (SamplerInfo)theEObject;
				T result = caseSamplerInfo(samplerInfo);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ImagePackage.IMAGE_INFO:
			{
				ImageInfo imageInfo = (ImageInfo)theEObject;
