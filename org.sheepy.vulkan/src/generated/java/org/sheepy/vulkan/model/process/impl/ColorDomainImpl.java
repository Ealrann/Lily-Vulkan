 ...
 * </p>
 * <ul>
 *   <li>{@link org.sheepy.vulkan.model.process.impl.ColorDomainImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.process.impl.ColorDomainImpl#getColorSpace <em>Color Space</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ColorDomainImpl extends MinimalEObjectImpl.Container implements ColorDomain
{
	...
	{
		return ProcessPackage.Literals.COLOR_DOMAIN;
	}
	...
	public void setFormat(EFormat newFormat)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.COLOR_DOMAIN__FORMAT, oldFormat, format));
	}
	...
	public void setColorSpace(EColorSpace newColorSpace)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.COLOR_DOMAIN__COLOR_SPACE, oldColorSpace, colorSpace));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case ProcessPackage.COLOR_DOMAIN__FORMAT:
				return getFormat();
			case ProcessPackage.COLOR_DOMAIN__COLOR_SPACE:
