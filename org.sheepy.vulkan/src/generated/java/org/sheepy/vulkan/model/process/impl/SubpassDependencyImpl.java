 ...
 * </p>
 * <ul>
 *   <li>{@link org.sheepy.vulkan.model.process.impl.SubpassDependencyImpl#getSrcSubpass <em>Src Subpass</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.process.impl.SubpassDependencyImpl#getDstSubpass <em>Dst Subpass</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.process.impl.SubpassDependencyImpl#getSrcStageMask <em>Src Stage Mask</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.process.impl.SubpassDependencyImpl#getDstStageMask <em>Dst Stage Mask</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.process.impl.SubpassDependencyImpl#getSrcAccessMask <em>Src Access Mask</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.process.impl.SubpassDependencyImpl#getDstAccessMask <em>Dst Access Mask</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubpassDependencyImpl extends MinimalEObjectImpl.Container implements SubpassDependency
{
	...
	{
		return ProcessPackage.Literals.SUBPASS_DEPENDENCY;
	}
	...
	public void setSrcSubpass(int newSrcSubpass)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.SUBPASS_DEPENDENCY__SRC_SUBPASS, oldSrcSubpass, srcSubpass));
	}
	...
	public void setDstSubpass(int newDstSubpass)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.SUBPASS_DEPENDENCY__DST_SUBPASS, oldDstSubpass, dstSubpass));
	}
	...
	public void setSrcStageMask(EPipelineStage newSrcStageMask)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.SUBPASS_DEPENDENCY__SRC_STAGE_MASK, oldSrcStageMask, srcStageMask));
	}
	...
	public void setDstStageMask(EPipelineStage newDstStageMask)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.SUBPASS_DEPENDENCY__DST_STAGE_MASK, oldDstStageMask, dstStageMask));
	}
	...
	public void setSrcAccessMask(int newSrcAccessMask)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.SUBPASS_DEPENDENCY__SRC_ACCESS_MASK, oldSrcAccessMask, srcAccessMask));
	}
	...
	public void setDstAccessMask(int newDstAccessMask)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.SUBPASS_DEPENDENCY__DST_ACCESS_MASK, oldDstAccessMask, dstAccessMask));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case ProcessPackage.SUBPASS_DEPENDENCY__SRC_SUBPASS:
				return getSrcSubpass();
			case ProcessPackage.SUBPASS_DEPENDENCY__DST_SUBPASS:
				return getDstSubpass();
			case ProcessPackage.SUBPASS_DEPENDENCY__SRC_STAGE_MASK:
				return getSrcStageMask();
			case ProcessPackage.SUBPASS_DEPENDENCY__DST_STAGE_MASK:
				return getDstStageMask();
			case ProcessPackage.SUBPASS_DEPENDENCY__SRC_ACCESS_MASK:
				return getSrcAccessMask();
			case ProcessPackage.SUBPASS_DEPENDENCY__DST_ACCESS_MASK:
