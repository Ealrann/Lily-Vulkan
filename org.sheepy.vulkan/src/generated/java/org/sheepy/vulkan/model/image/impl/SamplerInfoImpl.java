...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Sampler Info</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.sheepy.vulkan.model.image.impl.SamplerInfoImpl#getMinFilter <em>Min Filter</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.image.impl.SamplerInfoImpl#getMagFilter <em>Mag Filter</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.image.impl.SamplerInfoImpl#getMipmapMode <em>Mipmap Mode</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.image.impl.SamplerInfoImpl#getAddressMode <em>Address Mode</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.image.impl.SamplerInfoImpl#getBorderColor <em>Border Color</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.image.impl.SamplerInfoImpl#isAnisotropyEnabled <em>Anisotropy Enabled</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.image.impl.SamplerInfoImpl#isUnnormalizedCoordinates <em>Unnormalized Coordinates</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.image.impl.SamplerInfoImpl#isCompareEnable <em>Compare Enable</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.image.impl.SamplerInfoImpl#getLodBias <em>Lod Bias</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.image.impl.SamplerInfoImpl#getMinLod <em>Min Lod</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.image.impl.SamplerInfoImpl#getMaxLod <em>Max Lod</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.image.impl.SamplerInfoImpl#getMaxAnisotropy <em>Max Anisotropy</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SamplerInfoImpl extends MinimalEObjectImpl.Container implements SamplerInfo
{
	...
	{
		return ImagePackage.Literals.SAMPLER_INFO;
	}
	...
	public void setMinFilter(EFilter newMinFilter)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImagePackage.SAMPLER_INFO__MIN_FILTER, oldMinFilter, minFilter));
	}
	...
	public void setMagFilter(EFilter newMagFilter)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImagePackage.SAMPLER_INFO__MAG_FILTER, oldMagFilter, magFilter));
	}
	...
	public void setMipmapMode(ESamplerMipmapMode newMipmapMode)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImagePackage.SAMPLER_INFO__MIPMAP_MODE, oldMipmapMode, mipmapMode));
	}
	...
	public void setAddressMode(ESamplerAddressMode newAddressMode)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImagePackage.SAMPLER_INFO__ADDRESS_MODE, oldAddressMode, addressMode));
	}
	...
	public void setBorderColor(EBorderColor newBorderColor)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImagePackage.SAMPLER_INFO__BORDER_COLOR, oldBorderColor, borderColor));
	}
	...
	public void setAnisotropyEnabled(boolean newAnisotropyEnabled)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImagePackage.SAMPLER_INFO__ANISOTROPY_ENABLED, oldAnisotropyEnabled, anisotropyEnabled));
	}
	...
	public void setUnnormalizedCoordinates(boolean newUnnormalizedCoordinates)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImagePackage.SAMPLER_INFO__UNNORMALIZED_COORDINATES, oldUnnormalizedCoordinates, unnormalizedCoordinates));
	}
	...
	public void setCompareEnable(boolean newCompareEnable)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImagePackage.SAMPLER_INFO__COMPARE_ENABLE, oldCompareEnable, compareEnable));
	}
	...
	public void setLodBias(float newLodBias)
	{
		...
		lodBias = newLodBias;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImagePackage.SAMPLER_INFO__LOD_BIAS, oldLodBias, lodBias));
	}
	...
	public void setMinLod(int newMinLod)
	{
		...
		minLod = newMinLod;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImagePackage.SAMPLER_INFO__MIN_LOD, oldMinLod, minLod));
	}
	...
	public void setMaxLod(int newMaxLod)
	{
		...
		maxLod = newMaxLod;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImagePackage.SAMPLER_INFO__MAX_LOD, oldMaxLod, maxLod));
	}
	...
	public void setMaxAnisotropy(float newMaxAnisotropy)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImagePackage.SAMPLER_INFO__MAX_ANISOTROPY, oldMaxAnisotropy, maxAnisotropy));
	}
