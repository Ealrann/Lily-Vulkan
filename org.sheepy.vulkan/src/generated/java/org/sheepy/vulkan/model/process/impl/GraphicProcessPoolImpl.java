 ...
 * </p>
 * <ul>
 *   <li>{@link org.sheepy.vulkan.model.process.impl.GraphicProcessPoolImpl#getConfiguration <em>Configuration</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.process.impl.GraphicProcessPoolImpl#getRenderPassInfo <em>Render Pass Info</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.process.impl.GraphicProcessPoolImpl#getDepthImage <em>Depth Image</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GraphicProcessPoolImpl extends AbstractProcessPoolImpl<GraphicProcess> implements GraphicProcessPool
{
	...
	{
		return ProcessPackage.Literals.GRAPHIC_PROCESS_POOL;
	}
	...
	public EList<GraphicProcess> getProcesses()
	{
		if (processes == null)
		{
			processes = new EObjectContainmentEList<GraphicProcess>(GraphicProcess.class, this, ProcessPackage.GRAPHIC_PROCESS_POOL__PROCESSES);
		}
		return processes;
	}
	...
	public NotificationChain basicSetConfiguration(GraphicConfiguration newConfiguration, NotificationChain msgs)
	{
		...
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.GRAPHIC_PROCESS_POOL__CONFIGURATION, oldConfiguration, newConfiguration);
	...
	public void setConfiguration(GraphicConfiguration newConfiguration)
	{
		if (newConfiguration != configuration)
		{
			...
			if (configuration != null)
				msgs = ((InternalEObject)configuration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.GRAPHIC_PROCESS_POOL__CONFIGURATION, null, msgs);
			if (newConfiguration != null)
				msgs = ((InternalEObject)newConfiguration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.GRAPHIC_PROCESS_POOL__CONFIGURATION, null, msgs);
			msgs = basicSetConfiguration(newConfiguration, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.GRAPHIC_PROCESS_POOL__CONFIGURATION, newConfiguration, newConfiguration));
	}
	...
	public NotificationChain basicSetRenderPassInfo(RenderPassInfo newRenderPassInfo, NotificationChain msgs)
	{
		...
		if (eNotificationRequired())
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.GRAPHIC_PROCESS_POOL__RENDER_PASS_INFO, oldRenderPassInfo, newRenderPassInfo);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRenderPassInfo(RenderPassInfo newRenderPassInfo)
	{
		if (newRenderPassInfo != renderPassInfo)
		{
			...
			if (renderPassInfo != null)
				msgs = ((InternalEObject)renderPassInfo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.GRAPHIC_PROCESS_POOL__RENDER_PASS_INFO, null, msgs);
			if (newRenderPassInfo != null)
				msgs = ((InternalEObject)newRenderPassInfo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.GRAPHIC_PROCESS_POOL__RENDER_PASS_INFO, null, msgs);
			msgs = basicSetRenderPassInfo(newRenderPassInfo, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.GRAPHIC_PROCESS_POOL__RENDER_PASS_INFO, newRenderPassInfo, newRenderPassInfo));
	}
	...
	public DepthImage getDepthImage()
	{
		if (depthImage != null && depthImage.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProcessPackage.GRAPHIC_PROCESS_POOL__DEPTH_IMAGE, oldDepthImage, depthImage));
			}
		}
		return depthImage;
	}
	...
	public void setDepthImage(DepthImage newDepthImage)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.GRAPHIC_PROCESS_POOL__DEPTH_IMAGE, oldDepthImage, depthImage));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case ProcessPackage.GRAPHIC_PROCESS_POOL__CONFIGURATION:
				return basicSetConfiguration(null, msgs);
			case ProcessPackage.GRAPHIC_PROCESS_POOL__RENDER_PASS_INFO:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			...
			case ProcessPackage.GRAPHIC_PROCESS_POOL__DEPTH_IMAGE:
