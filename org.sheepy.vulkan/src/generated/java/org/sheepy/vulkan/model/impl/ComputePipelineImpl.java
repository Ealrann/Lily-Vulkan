 ...
 * </p>
 * <ul>
 *   <li>{@link org.sheepy.vulkan.model.impl.ComputePipelineImpl#getComputers <em>Computers</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.impl.ComputePipelineImpl#getWorkgroupSizeX <em>Workgroup Size X</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.impl.ComputePipelineImpl#getWorkgroupSizeY <em>Workgroup Size Y</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.impl.ComputePipelineImpl#getWorkgroupSizeZ <em>Workgroup Size Z</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.impl.ComputePipelineImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.impl.ComputePipelineImpl#getHeight <em>Height</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.impl.ComputePipelineImpl#getDepth <em>Depth</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComputePipelineImpl extends AbstractPipelineImpl implements ComputePipeline
{
	...
	{
		return VulkanPackage.Literals.COMPUTE_PIPELINE;
	}
	...
	public EList<Computer> getComputers()
	{
		if (computers == null)
		{
			computers = new EObjectContainmentEList<Computer>(Computer.class, this, VulkanPackage.COMPUTE_PIPELINE__COMPUTERS);
		}
		return computers;
	}
	...
	public void setWorkgroupSizeX(int newWorkgroupSizeX)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.COMPUTE_PIPELINE__WORKGROUP_SIZE_X, oldWorkgroupSizeX, workgroupSizeX));
	}
	...
	public void setWorkgroupSizeY(int newWorkgroupSizeY)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.COMPUTE_PIPELINE__WORKGROUP_SIZE_Y, oldWorkgroupSizeY, workgroupSizeY));
	}
	...
	public void setWorkgroupSizeZ(int newWorkgroupSizeZ)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.COMPUTE_PIPELINE__WORKGROUP_SIZE_Z, oldWorkgroupSizeZ, workgroupSizeZ));
	}
	...
	public void setWidth(int newWidth)
	{
		...
		width = newWidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.COMPUTE_PIPELINE__WIDTH, oldWidth, width));
	}
	...
	public void setHeight(int newHeight)
	{
		...
		height = newHeight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.COMPUTE_PIPELINE__HEIGHT, oldHeight, height));
	}
	...
	public void setDepth(int newDepth)
	{
		...
		depth = newDepth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.COMPUTE_PIPELINE__DEPTH, oldDepth, depth));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case VulkanPackage.COMPUTE_PIPELINE__COMPUTERS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case VulkanPackage.COMPUTE_PIPELINE__COMPUTERS:
				return getComputers();
			case VulkanPackage.COMPUTE_PIPELINE__WORKGROUP_SIZE_X:
				return getWorkgroupSizeX();
			case VulkanPackage.COMPUTE_PIPELINE__WORKGROUP_SIZE_Y:
				return getWorkgroupSizeY();
			case VulkanPackage.COMPUTE_PIPELINE__WORKGROUP_SIZE_Z:
				return getWorkgroupSizeZ();
			case VulkanPackage.COMPUTE_PIPELINE__WIDTH:
				return getWidth();
			case VulkanPackage.COMPUTE_PIPELINE__HEIGHT:
				return getHeight();
			case VulkanPackage.COMPUTE_PIPELINE__DEPTH:
				return getDepth();
		}
