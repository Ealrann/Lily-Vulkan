 ...
 * </p>
 * <ul>
 *   <li>{@link org.sheepy.vulkan.model.impl.PipelineBarrierImpl#isEnabled <em>Enabled</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.impl.PipelineBarrierImpl#getStage <em>Stage</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.impl.PipelineBarrierImpl#getSrcStage <em>Src Stage</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.impl.PipelineBarrierImpl#getDstStage <em>Dst Stage</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PipelineBarrierImpl extends MinimalEObjectImpl.Container implements PipelineBarrier
{
	...
	{
		return VulkanPackage.Literals.PIPELINE_BARRIER;
	}
	...
	public void setEnabled(boolean newEnabled)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.PIPELINE_BARRIER__ENABLED, oldEnabled, enabled));
	}
	...
	public void setStage(ECommandStage newStage)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.PIPELINE_BARRIER__STAGE, oldStage, stage));
	}
	...
	public void setSrcStage(EPipelineStage newSrcStage)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.PIPELINE_BARRIER__SRC_STAGE, oldSrcStage, srcStage));
	}
	...
	public void setDstStage(EPipelineStage newDstStage)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VulkanPackage.PIPELINE_BARRIER__DST_STAGE, oldDstStage, dstStage));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case VulkanPackage.PIPELINE_BARRIER__ENABLED:
				return isEnabled();
			case VulkanPackage.PIPELINE_BARRIER__STAGE:
				return getStage();
			case VulkanPackage.PIPELINE_BARRIER__SRC_STAGE:
				return getSrcStage();
			case VulkanPackage.PIPELINE_BARRIER__DST_STAGE:
				return getDstStage();
		}
