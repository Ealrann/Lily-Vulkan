 ...
 * </p>
 * <ul>
 *   <li>{@link org.sheepy.vulkan.model.process.impl.ImageTransitionImpl#getSrcLayout <em>Src Layout</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.process.impl.ImageTransitionImpl#getDstLayout <em>Dst Layout</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.process.impl.ImageTransitionImpl#getSrcAccess <em>Src Access</em>}</li>
 *   <li>{@link org.sheepy.vulkan.model.process.impl.ImageTransitionImpl#getDstAccess <em>Dst Access</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImageTransitionImpl extends MinimalEObjectImpl.Container implements ImageTransition
{
	...
	{
		return ProcessPackage.Literals.IMAGE_TRANSITION;
	}
	...
	public void setSrcLayout(EImageLayout newSrcLayout)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.IMAGE_TRANSITION__SRC_LAYOUT, oldSrcLayout, srcLayout));
	}
	...
	public void setDstLayout(EImageLayout newDstLayout)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.IMAGE_TRANSITION__DST_LAYOUT, oldDstLayout, dstLayout));
	}
	...
	public void setSrcAccess(int newSrcAccess)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.IMAGE_TRANSITION__SRC_ACCESS, oldSrcAccess, srcAccess));
	}
	...
	public void setDstAccess(int newDstAccess)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.IMAGE_TRANSITION__DST_ACCESS, oldDstAccess, dstAccess));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case ProcessPackage.IMAGE_TRANSITION__SRC_LAYOUT:
				return getSrcLayout();
			case ProcessPackage.IMAGE_TRANSITION__DST_LAYOUT:
				return getDstLayout();
			case ProcessPackage.IMAGE_TRANSITION__SRC_ACCESS:
				return getSrcAccess();
			case ProcessPackage.IMAGE_TRANSITION__DST_ACCESS:
				return getDstAccess();
		}
