...
import org.sheepy.vulkan.pipeline.graphic.render.impl.AbstractIntegerIndexDescriptor;
...
public class IndexBufferDescriptor extends AbstractIntegerIndexDescriptor<Vertex>
{
	...
	{
		var attributeDescriptions = VkVertexInputAttributeDescription.calloc(2);
