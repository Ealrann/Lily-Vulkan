...
@Allocation(context = ProcessContext.class, activator = ComputePipeline.FeatureIDs.RECORD)
@AllocationDependency(type = ComputePipelineAllocation.class)
@AllocationDependency(features = ComputePipeline.FeatureIDs.TASK_PKGS, type = IRecordableAdapter.class)
