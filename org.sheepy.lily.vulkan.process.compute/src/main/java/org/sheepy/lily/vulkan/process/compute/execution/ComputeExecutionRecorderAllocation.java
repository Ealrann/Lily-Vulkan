...
public class ComputeExecutionRecorderAllocation extends AbstractExecutionRecorderAllocation
{
	public ComputeExecutionRecorderAllocation(ComputeCommandBuffer commandBuffer, Submission submission, int index)
	{
