...
@Allocation
@AllocationDependency(features = ImageDescriptor.FeatureIDs.IMAGES, type = IVkImageAllocation.class)
@AllocationDependency(features = ImageDescriptor.FeatureIDs.SAMPLER, type = SamplerAllocation.class)
