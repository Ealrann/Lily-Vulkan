...
@AllocationChild(features = {DescriptorPool.FeatureIDs.DESCRIPTOR_SETS})
public final class DescriptorPoolAllocation implements IAdapter
{
									...
									IAllocationState allocationState)
	{
		...
		final var descriptorSets = descriptorPool.descriptorSets();
		...
		for (int i = 0; i < descriptorSetCount; i++)
		{
			...
			for (final var descriptor : descriptorSet.descriptors())
			{
