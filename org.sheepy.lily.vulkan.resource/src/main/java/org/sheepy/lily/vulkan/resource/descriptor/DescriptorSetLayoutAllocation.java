...
@AllocationDependency(features = {DescriptorSet.FeatureIDs.DESCRIPTORS}, type = IDescriptorAllocation.class)
public final class DescriptorSetLayoutAllocation implements IDescriptorSetLayoutAllocation
{
										 ...
										 IObservatoryBuilder observatory)
	{
		...
		observatory.listenNoParam(config::setAllocationObsolete, DescriptorSet.FeatureIDs.DESCRIPTORS);
