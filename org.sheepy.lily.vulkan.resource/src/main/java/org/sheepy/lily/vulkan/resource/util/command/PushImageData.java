...
public final class PushImageData implements IDataFlow
{
	...
	public void record(final RecordContext recordContext)
	{
		...
		hostBarrier.dstAccessMask(EAccess.TRANSFER_READ_BIT.value());

		vkCmdPipelineBarrier(commandBuffer, srcStage.value(), blitStage.value(), 0, null, barriers, null);
	...
	{
		return "PushImageData{ticket=" + ticket + ", trgImage=" + trgImage + '}';
	}
}
